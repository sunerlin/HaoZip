...
typedef RCZIP_QUALIFIER RCInOutStream _PPMD_FILE;
#define _PPMD_E_GETC(fp)   RCZIP_QUALIFIER stream_getc(fp)
#define _PPMD_E_PUTC(c,fp) RCZIP_QUALIFIER stream_putc((c),fp)
#define _PPMD_D_GETC(fp)   RCZIP_QUALIFIER stream_getc(fp)
#define _PPMD_D_PUTC(c,fp) RCZIP_QUALIFIER stream_putc((c),fp)
