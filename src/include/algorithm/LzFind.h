...
byte_t *MatchFinder_GetPointerToCurrentPos(CMatchFinder *p);
...
uint32_t * GetMatchesSpec1(uint32_t lenLimit, uint32_t curMatch, uint32_t pos, const byte_t *buffer, CLzRef *son,
...
typedef byte_t (*Mf_GetIndexByte_Func)(void *object, int32_t index);
typedef uint32_t (*Mf_GetNumAvailableBytes_Func)(void *object);
typedef const byte_t * (*Mf_GetPointerToCurrentPos_Func)(void *object);
