...
#ifndef __RCZipSplitHandler_h_
#define __RCZipSplitHandler_h_  1
...
class RCZipSplitHandler :
    public IUnknownImpl3<IInArchive, IInArchiveGetStream, ISetCompressCodecsInfo>
{
public:
...
private:
    ...
    @param [in] openCallback 打开文档接口指针
    @return 成功返回RC_S_OK，否则返回错误号
    */
