...
#ifndef __RCArjHandler_h_
#define __RCArjHandler_h_ 1
...
public:
    ...
    */
    ...
    @param [in] maxCheckStartPosition 签名检测的最大偏移
    @param [in] callback 打开文档回调接口指针
    @return 成功返回RC_S_OK，否则返回错误号
    */
    HResult Open2(IInStream* inStream, const uint64_t* maxCheckStartPosition, IArchiveOpenCallback* callback);
...
private:
    ...
    */
    ...
    /** arj文档
    */
    RCArjInArchive m_archive;

    /** arj项
    */
    RCVector<RCArjItem> m_items;
